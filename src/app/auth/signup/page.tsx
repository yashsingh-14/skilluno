...
export default function SignupPage() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-black text-white px-4 relative overflow-hidden">
            ...
            <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-pink-600/10 rounded-full blur-[150px] animate-float-slow pointer-events-none" />
            <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-purple-600/10 rounded-full blur-[120px] animate-float pointer-events-none" />
                ...
                <div className="gradient-border rounded-2xl">
                    <div className="rounded-2xl bg-zinc-950/90 backdrop-blur-xl p-8 space-y-8">
                        ...
                        <div className="text-center space-y-3">
                            ...
                            <p className="text-sm text-zinc-500">Join the SkillUNO community</p>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-zinc-950 px-3 text-zinc-600 tracking-wider">Or with email</span>
                            </div>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-4 py-3 text-sm font-bold text-white transition-all hover:from-purple-500 hover:to-pink-500 hover:shadow-[0_0_25px_rgba(147,51,234,0.3)] disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
                            >
                                {loading ? (
